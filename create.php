...
<body class="container">
    ...
    <main class="column pt-3 row bg-info rounded">
        <section class="col-sm-8">
            <hr>
            <h2 class="h2">Create Post</h2><hr>
            <div>
                <form method="GET">
                    <input type="text" name="title" placeholder="Blog Title" class="form-control" ><br>
                    <input type="text" name="author" placeholder="author" class="form-control"><br>
                    <input type="text" name="tags" placeholder="Tags" class="form-control"><br>
                    <input type="text" name="images" placeholder="images" class="form-control"><br>
