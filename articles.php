    ...
    <main class="column pt-3 row bg-info rounded">
        <section class="col-sm-8">
            ...
            <?php foreach($query as $q){?>
                <h2 class="text-center"><?php echo $q['title'];?></h2><hr>
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <button class="btn btn-primary btn-block "><a href="edit.php" class="text-decoration-none text-dark text-uppercase">EDIT</a></button>
                        </div>
                    ...
                    <p class="container pt-3"><?php echo $q['content'];?></p>
                    <!--<p>Id: <?php echo $q['id'];?></p>-->
                </div>
            <?php } ?>
        </section>
