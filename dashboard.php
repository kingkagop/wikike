            ...
            <h2 class="text-center">Articles</h2><hr>
                ...
                <div class="row">
                    <?php foreach($query as $q){?>
                        <div class="col-md-4 ">
                            <img class="card-image-top" src="<?php echo $q['image'];?>">
                            <h3 class="h3 card-title"><?php echo $q['title'];?></h3>
                            <p class="card-text"> <?php echo $q['thedescription'];?></p>
                            <a href="articles.php?id=<?php echo $q['id'];?>" target="_blank" class="read-more">More...</a>
                        </div>
                    <?php } ?>
                </div>
